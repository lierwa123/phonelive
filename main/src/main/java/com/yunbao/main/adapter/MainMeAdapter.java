...
public class MainMeAdapter extends RecyclerView.Adapter<MainMeAdapter.Vh> {
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(UserItemBean bean) {
            ...
            if (bean.getName().equals("代理充值")){
                ImgLoader.display(mContext, R.mipmap.icon_dlcz, mThumb);
            }else if(bean.getName().equals("代理转账")){
                ImgLoader.display(mContext, R.mipmap.icon_dlzz, mThumb);
            }else{
